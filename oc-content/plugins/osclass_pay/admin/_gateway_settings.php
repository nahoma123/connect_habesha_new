<?php
  ...
  $stripe_webhook_secret_key = osp_param_update('stripe_webhook_secret_key', 'plugin_action', 'value_crypt', 'plugin-osclass_pay');
  ...
  $stripe_webhook_secret_key_test = osp_param_update('stripe_webhook_secret_key_test', 'plugin_action', 'value_crypt', 'plugin-osclass_pay');
  ...
  $yookassa_enabled = osp_param_update('yookassa_enabled', 'plugin_action', 'check', 'plugin-osclass_pay');
  $yookassa_shop_id = osp_param_update('yookassa_shop_id', 'plugin_action', 'value', 'plugin-osclass_pay');
  $yookassa_api_secret = osp_param_update('yookassa_api_secret', 'plugin_action', 'value_crypt', 'plugin-osclass_pay');
  ...
  $makecommerce_enabled = osp_param_update('makecommerce_enabled', 'plugin_action', 'check', 'plugin-osclass_pay');
  $makecommerce_shop_id = osp_param_update('makecommerce_shop_id', 'plugin_action', 'value', 'plugin-osclass_pay');
  $makecommerce_public_key = osp_param_update('makecommerce_public_key', 'plugin_action', 'value', 'plugin-osclass_pay');
  $makecommerce_secret_key = osp_param_update('makecommerce_secret_key', 'plugin_action', 'value_crypt', 'plugin-osclass_pay');
  $makecommerce_test_mode = osp_param_update('makecommerce_test_mode', 'plugin_action', 'check', 'plugin-osclass_pay');
      ...
      <form name="promo_form" id="promo_form" action="<?php echo osc_admin_base_url(true); ?>" method="POST" enctype="multipart/form-data" >
        ...
        <div class="mb-method mb-payherelk <?php if($payherelk_enabled == 1) { ?>enabled<?php } ?>">
          ...
          <div class="mb-method-body">
            ...
            <div class="mb-row mb-method-links">
              <a href="https://payhere.lk/" target="_blank" class="mb-prod osp-has-tooltip" title="<?php echo osc_esc_html(__('Link will open in new window', 'osclass_pay')); ?>"><i class="fa fa-rocket"></i> <span><?php _e('Open Payhere.lk Production', 'osclass_pay'); ?></span></a>
              <a href="https://sandbox.payhere.lk/" target="_blank" class="mb-sand osp-has-tooltip" title="<?php echo osc_esc_html(__('Link will open in new window', 'osclass_pay')); ?>"><i class="fa fa-cubes"></i> <span><?php _e('Open Payhere.lk Sandbox', 'osclass_pay'); ?></span></a>
              <a href="https://support.payhere.lk/api-&-mobile-sdk/checkout-api" target="_blank" class="mb-docu osp-has-tooltip" title="<?php echo osc_esc_html(__('Link will open in new window', 'osclass_pay')); ?>"><i class="fa fa-graduation-cap"></i> <span><?php _e('Open Payhere.lk Documentation', 'osclass_pay'); ?></span></a>
            </div>
        ...
        <div class="mb-method mb-stripe <?php if($stripe_enabled == 1) { ?>enabled<?php } ?>">
          ...
          <div class="mb-method-body">
            ...
            <div class="mb-row mb-notes">
              <div class="mb-line"><?php echo sprintf(__('Setup your webhook at: %s', 'osclass_pay'), 'https://dashboard.stripe.com/webhooks'); ?></div>
              <div class="mb-line"><?php echo sprintf(__('Webhook must point to: %s', 'osclass_pay'), osc_base_url() . 'oc-content/plugins/osclass_pay/payments/stripe/webhook.php'); ?></div>
              <div class="mb-line"><?php echo sprintf(__('Webhook events: %s', 'osclass_pay'), 'payment_intent.succeeded, checkout.session.completed'); ?></div>
            </div>
            ...
            <div class="mb-line">
              <label for="stripe_webhook_secret_key"><span><?php _e('Stripe Webhook Secret Key', 'osclass_pay'); ?></span></label>
              <input name="stripe_webhook_secret_key" id="stripe_webhook_secret_key" type="password" value="<?php echo $stripe_webhook_secret_key ; ?>" />
            </div>
            ...
            <div class="mb-line">
              <label for="stripe_webhook_secret_key_test"><span><?php _e('Stripe Test Webhook Secret Key', 'osclass_pay'); ?></span></label>
              <input name="stripe_webhook_secret_key_test" id="stripe_webhook_secret_key_test" type="password" value="<?php echo $stripe_webhook_secret_key_test ; ?>" />
            </div>
          </div>
        </div>
        ...
        <div class="mb-method mb-pagseguro <?php if($pagseguro_enabled == 1) { ?>enabled<?php } ?>">
          ...
          <div class="mb-method-body">
            ...
            <div class="mb-row mb-notes" style="margin-bottom:35px;">
              ...
              <div class="mb-line"><?php _e('Transaction notification URL:', 'osclass_pay'); ?> <?php echo osc_base_url(); ?>oc-content/plugins/osclass_pay/payments/pagseguro/notify.php</div>
              <div class="mb-line"><?php _e('Redirect page URL:', 'osclass_pay'); ?> <?php echo osc_base_url(); ?>oc-content/plugins/osclass_pay/payments/pagseguro/return.php</div>
              <div class="mb-line"><?php _e('Redirect with transaction code, name of parameter:', 'osclass_pay'); ?> transaction_id</div>
            </div>
        ...
        <div class="mb-method mb-ccavenue <?php if($ccavenue_enabled == 1) { ?>enabled<?php } ?>">
          ...
          <div class="mb-method-body">
            <div class="mb-row mb-notes">
              ...
              <div class="mb-line"><strong><?php _e('This payment method require PHP 7.0 or older (mcrypt_module_open function dependency).', 'osclass_pay'); ?> (</strong></div>
            </div>
        ...
        <!-- YOOKASSA MONEY -->
        <div class="mb-method mb-yookassa <?php if($yookassa_enabled == 1) { ?>enabled<?php } ?>">
          <div class="mb-method-name">
            <i class="mb-method-status fa fa-<?php if($yookassa_enabled == 1) { ?>check<?php } else { ?>times<?php } ?>"></i>
            <span><?php _e('YooKassa Payments', 'osclass_pay'); ?></span>
            <img src="<?php echo osp_url(); ?>img/payments/yookassa.png"/>
          </div>

          <div class="mb-method-body">
            <div class="mb-row mb-method-links">
              <a href="https://yookassa.ru/" target="_blank" class="mb-prod osp-has-tooltip" title="<?php echo osc_esc_html(__('Link will open in new window', 'osclass_pay')); ?>"><i class="fa fa-rocket"></i> <span><?php _e('Open YooKassa page', 'osclass_pay'); ?></span></a>
              <a href="https://yookassa.ru/developers/payment-acceptance/testing-and-going-live/testing" target="_blank" class="mb-docu osp-has-tooltip" title="<?php echo osc_esc_html(__('Link will open in new window', 'osclass_pay')); ?>"><i class="fa fa-graduation-cap"></i> <span><?php _e('Open Testing Guide', 'osclass_pay'); ?></span></a>
            </div>

            <?php if(osp_currency() <> 'RUB') { ?>
              <div class="mb-row mb-errors">
                <div class="mb-line"><?php _e('YooKassa is not available, currency must be set to RUB to be able to use this gateway.', 'osclass_pay'); ?></div>
              </div>
            <?php } ?>

            <div class="mb-row mb-notes">
              <div class="mb-line"><?php _e('In your YooKassa account setup notification URL into following:', 'osclass_pay'); ?></div>
              <div class="mb-line"><?php echo osc_base_url() . 'oc-content/plugins/osclass_pay/payments/yookassa/notification.php'; ?></div>
            </div>

            <div class="mb-line">
              <label for="yookassa_enabled"><span><?php _e('Enable YooKassa Money Payments', 'osclass_pay'); ?></span></label>
              <input name="yookassa_enabled" id="yookassa_enabled" class="element-slide" type="checkbox" <?php echo ($yookassa_enabled == 1 ? 'checked' : ''); ?> />
            </div>

            <div class="mb-line">
              <label for="yookassa_shop_id"><span><?php _e('YooKassa Shop ID (Account/Merchant)', 'osclass_pay'); ?></span></label>
              <input name="yookassa_shop_id" id="yookassa_shop_id" type="text" value="<?php echo $yookassa_shop_id; ?>" />
            </div>

            <div class="mb-line">
              <label for="yookassa_api_secret"><span><?php _e('YooKassa Api Secret Key', 'osclass_pay'); ?></span></label>
              <input name="yookassa_api_secret" id="yookassa_api_secret" type="password" value="<?php echo $yookassa_api_secret; ?>" />
            </div>
        ...
        <!-- MakeCommerce -->
        <div class="mb-method mb-makecommerce <?php if($makecommerce_enabled == 1) { ?>enabled<?php } ?>">
          <div class="mb-method-name">
            <i class="mb-method-status fa fa-<?php if($makecommerce_enabled == 1) { ?>check<?php } else { ?>times<?php } ?>"></i>
            <span><?php _e('MakeCommerce Payments (by Maksekeskus.ee)', 'osclass_pay'); ?></span>
            <img src="<?php echo osp_url(); ?>img/payments/makecommerce.png"/>
          </div>

          <div class="mb-method-body">
            <div class="mb-row mb-method-links">
              <a href="https://merchant.maksekeskus.ee" target="_blank" class="mb-prod osp-has-tooltip" title="<?php echo osc_esc_html(__('Link will open in new window', 'osclass_pay')); ?>"><i class="fa fa-rocket"></i> <span><?php _e('Open MakeCommerce Home', 'osclass_pay'); ?></span></a>
              <a href="https://developer.maksekeskus.ee/reference.php" target="_blank" class="mb-docu osp-has-tooltip" title="<?php echo osc_esc_html(__('Link will open in new window', 'osclass_pay')); ?>"><i class="fa fa-graduation-cap"></i> <span><?php _e('Open API documentation', 'osclass_pay'); ?></span></a>
              <a href="https://github.com/maksekeskus/maksekeskus-php" target="_blank" class="mb-docu osp-has-tooltip" title="<?php echo osc_esc_html(__('Link will open in new window', 'osclass_pay')); ?>"><i class="fa fa-graduation-cap"></i> <span><?php _e('Open PHP SDK Github', 'osclass_pay'); ?></span></a>
            </div>

            <div class="mb-line">
              <label for="makecommerce_enabled"><span><?php _e('Enable MakeCommerce Payments', 'osclass_pay'); ?></span></label>
              <input name="makecommerce_enabled" id="makecommerce_enabled" class="element-slide" type="checkbox" <?php echo ($makecommerce_enabled == 1 ? 'checked' : ''); ?> />
            </div>

            <div class="mb-line">
              <label for="makecommerce_shop_id"><span><?php _e('MakeCommerce Shop Id', 'osclass_pay'); ?></span></label>
              <input name="makecommerce_shop_id" id="makecommerce_shop_id" type="text" value="<?php echo $makecommerce_shop_id; ?>" />

              <div class="mb-explain"><?php _e('Enter your shop id issued by your payment provider', 'osclass_pay'); ?></div>
            </div>

            <div class="mb-line">
              <label for="makecommerce_secret_key"><span><?php _e('MakeCommerce Shop Secret Key', 'osclass_pay'); ?></span></label>
              <input name="makecommerce_secret_key" id="makecommerce_secret_key" type="text" value="<?php echo $makecommerce_secret_key; ?>" />

              <div class="mb-explain"><?php _e('Enter your shop secret key issued by your payment provider', 'osclass_pay'); ?></div>
            </div>

            <div class="mb-line">
              <label for="makecommerce_public_key"><span><?php _e('MakeCommerce Shop Public Key', 'osclass_pay'); ?></span></label>
              <input name="makecommerce_public_key" id="makecommerce_public_key" type="text" value="<?php echo $makecommerce_public_key; ?>" />

              <div class="mb-explain"><?php _e('Enter your shop public issued by your payment provider', 'osclass_pay'); ?></div>
            </div>

            <div class="mb-line">
              <label for="makecommerce_test_mode"><span><?php _e('Enable Test Mode', 'osclass_pay'); ?></span></label>
              <input name="makecommerce_test_mode" id="makecommerce_test_mode" class="element-slide" type="checkbox" <?php echo ($makecommerce_test_mode == 1 ? 'checked' : ''); ?> />
            </div>
          </div>
        </div>
