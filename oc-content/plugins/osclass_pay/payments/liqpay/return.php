<?php
  ...
  $tx = Params::getParam('liqpay_transaction_id');
  ...
  if(OSP_DEBUG) {
    ...
    mail(osc_contact_email() , 'OSCLASS PAY - LIQPAY RETURN DEBUG RESPONSE', $emailtext);
  }

  // $data = osp_get_custom(Params::getParam('extra'));
  // $product_type = explode('x', @$data['product']);
  $product_type = Params::getParam('liqpay_product_type');
