...
$tx = Params::getParam('transaction_id');
...
if(OSP_DEBUG) {
  ...
  mail(osc_contact_email() , 'OSCLASS PAY - YOOMONEY (RETURN) DEBUG RESPONSE', $emailtext);
}

$data = osp_get_custom(Params::getParam('extras'));
